...
type AccountsEdges struct {
	// FromAccountID holds the value of the from_account_id edge.
	FromAccountID []*Transfers `json:"from_account_id,omitempty"`
	// ToAccountID holds the value of the to_account_id edge.
	ToAccountID []*Transfers `json:"to_account_id,omitempty"`
	// loadedTypes holds the information for reporting if a
	// type was loaded (or requested) in eager-loading or not.
	loadedTypes [2]bool
}

// FromAccountIDOrErr returns the FromAccountID value or an error if the edge
// was not loaded in eager-loading.
func (e AccountsEdges) FromAccountIDOrErr() ([]*Transfers, error) {
	if e.loadedTypes[0] {
		return e.FromAccountID, nil
	}
	return nil, &NotLoadedError{edge: "from_account_id"}
}

// ToAccountIDOrErr returns the ToAccountID value or an error if the edge
// was not loaded in eager-loading.
func (e AccountsEdges) ToAccountIDOrErr() ([]*Transfers, error) {
	if e.loadedTypes[1] {
		return e.ToAccountID, nil
	}
	return nil, &NotLoadedError{edge: "to_account_id"}
}
...
// QueryFromAccountID queries the "from_account_id" edge of the Accounts entity.
func (a *Accounts) QueryFromAccountID() *TransfersQuery {
	return (&AccountsClient{config: a.config}).QueryFromAccountID(a)
}

// QueryToAccountID queries the "to_account_id" edge of the Accounts entity.
func (a *Accounts) QueryToAccountID() *TransfersQuery {
	return (&AccountsClient{config: a.config}).QueryToAccountID(a)
}
