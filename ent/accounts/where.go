...
// HasFromAccountID applies the HasEdge predicate on the "from_account_id" edge.
func HasFromAccountID() predicate.Accounts {
	return predicate.Accounts(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FromAccountIDTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, FromAccountIDTable, FromAccountIDColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasFromAccountIDWith applies the HasEdge predicate on the "from_account_id" edge with a given conditions (other predicates).
func HasFromAccountIDWith(preds ...predicate.Transfers) predicate.Accounts {
	return predicate.Accounts(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FromAccountIDInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, FromAccountIDTable, FromAccountIDColumn),
		)
...
// HasToAccountID applies the HasEdge predicate on the "to_account_id" edge.
func HasToAccountID() predicate.Accounts {
	return predicate.Accounts(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ToAccountIDTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ToAccountIDTable, ToAccountIDColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasToAccountIDWith applies the HasEdge predicate on the "to_account_id" edge with a given conditions (other predicates).
func HasToAccountIDWith(preds ...predicate.Transfers) predicate.Accounts {
	return predicate.Accounts(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ToAccountIDInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ToAccountIDTable, ToAccountIDColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
